...
| <a name="input_network_suffix"></a> [network\_suffix](#input\_network\_suffix) | The network suffix, will be used for generating the final name. | `string` | n/a | yes |
| <a name="input_prefix"></a> [prefix](#input\_prefix) | Prefix applied to service to all resources. | `string` | n/a | yes |
| <a name="input_private_domain"></a> [private\_domain](#input\_private\_domain) | The DNS name of the local  managed zone, for instance 'example.local.'. | `string` | n/a | yes |
| <a name="input_project_id"></a> [project\_id](#input\_project\_id) | Project ID for Private Shared VPC. | `string` | n/a | yes |
| <a name="input_public_domain"></a> [public\_domain](#input\_public\_domain) | The DNS name of peering managed zone, for instance 'example.com.'. Require when dns\_enable\_outbound\_forwarding=true | `string` | n/a | yes |
...
| <a name="input_private_ca_name"></a> [private\_ca\_name](#input\_private\_ca\_name) | Certificate authority name for proxy service, required when secure web proxy is enabled. | `string` | `null` | no |
| <a name="input_private_ca_pool_id"></a> [private\_ca\_pool\_id](#input\_private\_ca\_pool\_id) | Pool name for certificate authority, required when secure web proxy is enabled. | `string` | `null` | no |
