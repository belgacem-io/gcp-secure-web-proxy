...
variable "private_ca_pool_id" {
  description = "Pool name for certificate authority, required when secure web proxy is enabled."
  type        = string
  default = null
}

variable "private_ca_name" {
  description = "Certificate authority name for proxy service, required when secure web proxy is enabled."
  type        = string
  default = null
}